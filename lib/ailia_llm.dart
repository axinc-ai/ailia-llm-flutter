...
class ailiaLlmFFI {
  ...
  late final _ailiaLLMGetPromptTokenCountPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<AILIALLM>,
              ffi.Pointer<ffi.UnsignedInt>)>>('ailiaLLMGetPromptTokenCount');
  late final _ailiaLLMGetPromptTokenCount =
      _ailiaLLMGetPromptTokenCountPtr.asFunction<
          int Function(ffi.Pointer<AILIALLM>, ffi.Pointer<ffi.UnsignedInt>)>();
  ...
  int ailiaLLMGetGeneratedTokenCount(
    ffi.Pointer<AILIALLM> llm,
    ffi.Pointer<ffi.UnsignedInt> cnt,
  ) {
    return _ailiaLLMGetGeneratedTokenCount(
      llm,
      cnt,
    );
  }

  late final _ailiaLLMGetGeneratedTokenCountPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<AILIALLM>,
              ffi.Pointer<ffi.UnsignedInt>)>>('ailiaLLMGetGeneratedTokenCount');
  late final _ailiaLLMGetGeneratedTokenCount =
      _ailiaLLMGetGeneratedTokenCountPtr.asFunction<
          int Function(ffi.Pointer<AILIALLM>, ffi.Pointer<ffi.UnsignedInt>)>();
