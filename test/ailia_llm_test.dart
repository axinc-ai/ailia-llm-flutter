...
void main() {
  ...
  group('AiliaLLMModel Integration Tests', () {
    ...
    setUpAll(() {
      // Use model from ~/claude_workspace/models/ as specified in CLAUDE.md
      final homeDir = Platform.environment['HOME'] ?? '';
      modelPath = '$homeDir/claude_workspace/models/gemma-2-2b-it-Q4_K_M.gguf';
      ...
      expect(File(modelPath).existsSync(), isTrue,
        reason: 'Model file not found at $modelPath. '
                'Please ensure model is available at ~/claude_workspace/models/');
    });
